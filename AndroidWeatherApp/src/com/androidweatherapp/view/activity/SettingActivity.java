...
public class SettingActivity extends Activity {
	...
	private Spinner displayTypeSpinner = null;
		...
		displayTypeSpinner
				.setOnItemSelectedListener(new OnItemSelectedListener() {
					...
					public void onItemSelected(AdapterView<?> arg0, View arg1,
						...
						String itemSelected = (String) arg0
								.getItemAtPosition(arg2);
						controller.updateDisplayType(itemSelected);
						Toast.makeText(SettingActivity.this,
								"Display Type val is Updated!",
								Toast.LENGTH_SHORT).show();
	...
	private void initialize() {
		...
		displayTypeSpinner = (Spinner) this
				.findViewById(R.id.settingDisplayTypeSpinner);
		...
		try {
			displayTypeSpinner.setSelection(
					Arrays.asList(
							getResources().getStringArray(R.array.displayType))
							.indexOf(setting.getDisplayType()), true);
